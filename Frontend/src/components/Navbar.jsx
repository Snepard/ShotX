        ...
        >
          <div className={`flex items-center justify-between ${
            ...
            <NavLink to="/" className="flex items-center space-x-3 group">
              ...
              <span className={`font-black tracking-wider text-white hologram-text navbar-transition ${
                ...
                {navLinks.map((link) => (
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) => `
                      ...
                      ${isActive ? 'text-cyan-400 bg-white/10' : 'text-gray-300 hover:text-cyan-400 hover:bg-white/5'}
                    `}
                  >
                    {link.name}
                  </NavLink>
